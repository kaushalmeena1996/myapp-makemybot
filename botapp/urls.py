...
urlpatterns = [
    ...
    url(r'^chatbots//?(?P<bot_id>\d+)?/chat$', views.chatbots01, name='chatbots01'),
    ...
    url(r'^setting/user$', views.setting00, name='setting00'),
    url(r'^setting/bot$', views.setting01, name='setting01'),
