...
function cAction(actionCode, e) {
    ...
    switch (actionCode) {
        ...
        case 2:
            ...
            if (document.title == 'MakeMyBot: Chat') {
...
function settingAction(actionCode) {
    ...
    switch (actionCode) {
        ...
        case 1:
            botImage = $('#botOld').val();
            filePath = filePath + botImage;
            $("#botContainer").val(filePath);
            $('#botImage').attr("src", filePath);
            break;

        case 2:
            filePath = "/static/avtaar/bot_default.png";
            $("#botContainer").val(filePath);
            $('#botImage').attr("src", filePath);
            break;
    }
...
function defaulImage() {
    var filePath = "/static/avtaar/bot_default.png";
    $("#botContainer").val(filePath);
    $('#botImage').attr("src", filePath);
}
